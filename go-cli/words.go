...
func registerSDKWords(r *eng.Registry, client *sdk.EnergyChartsSDK) {
...
func runOp(client *sdk.EnergyChartsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
