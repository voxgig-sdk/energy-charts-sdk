...
// EnergyCharts SDK TrafficModel entity
...
class TrafficModelEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TrafficModelEntity($this->_client, $opts);
    }

    /**
     * @param TrafficModel|array $args TrafficModel data (assoc-array) to store.
     */
    ...
    /**
     * @return TrafficModel|array The current TrafficModel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TrafficModel fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TrafficModel fields).
     */
     ...
     *
     * @param TrafficModelListMatch|array|null $reqmatch Match filter (any subset
     *   of TrafficModel fields) as an assoc-array; TrafficModelListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TrafficModel[]|array A list of TrafficModel items as assoc-arrays at
