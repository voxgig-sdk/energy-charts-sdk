...
class PublicPowerForecastEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "public_power_forecast";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PublicPowerForecastEntity($this->_client, $opts);
    }

    /**
     * @param PublicPowerForecast|array $args PublicPowerForecast data (assoc-array) to store.
     */
    ...
    /**
     * @return PublicPowerForecast|array The current PublicPowerForecast data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PublicPowerForecast fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PublicPowerForecast fields).
     */
     ...
     *
     * @param PublicPowerForecastListMatch|array|null $reqmatch Match filter (any subset
     *   of PublicPowerForecast fields) as an assoc-array; PublicPowerForecastListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PublicPowerForecast[]|array A list of PublicPowerForecast items as assoc-arrays at
