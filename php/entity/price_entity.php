...
class PriceEntity
{
     ...
     * Load a single Price.
     *
     * @param PriceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PriceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Price|array The loaded Price as an assoc-array at the
