...
// EnergyCharts SDK ProductionModel entity
...
class ProductionModelEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProductionModelEntity($this->_client, $opts);
    }

    /**
     * @param ProductionModel|array $args ProductionModel data (assoc-array) to store.
     */
    ...
    /**
     * @return ProductionModel|array The current ProductionModel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProductionModel fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProductionModel fields).
     */
     ...
     *
     * @param ProductionModelLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProductionModelLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProductionModel|array The loaded ProductionModel as an assoc-array at the
