...
// EnergyCharts SDK utility type

class EnergyChartsUtility
{
    ...
    public static function copy(EnergyChartsUtility $src): EnergyChartsUtility
    {
        $u = new EnergyChartsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
