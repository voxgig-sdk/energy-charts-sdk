...
class InstalledModelEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ENERGYCHARTS_TEST_INSTALLED_MODEL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function installed_model_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ENERGYCHARTS_TEST_INSTALLED_MODEL_ENTID");
