...
class TrafficModelEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->TrafficModel(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->TrafficModel(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ENERGY_CHARTS_TEST_TRAFFIC_MODEL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function traffic_model_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ENERGY_CHARTS_TEST_TRAFFIC_MODEL_ENTID");
