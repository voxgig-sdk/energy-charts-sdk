...
class DailyAvgDictDirectTest extends TestCase
{
    public function test_direct_list_daily_avg_dict(): void
    {
        $setup = daily_avg_dict_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-daily_avg_dict", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
