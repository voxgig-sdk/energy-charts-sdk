...
class DailyAvgDictEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->DailyAvgDict(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->DailyAvgDict(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ENERGY_CHARTS_TEST_DAILY_AVG_DICT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function daily_avg_dict_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ENERGY_CHARTS_TEST_DAILY_AVG_DICT_ENTID");
