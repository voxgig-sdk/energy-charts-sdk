...
class RenShareModelDirectTest extends TestCase
{
    public function test_direct_list_ren_share_model(): void
    {
        $setup = ren_share_model_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-ren_share_model", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
