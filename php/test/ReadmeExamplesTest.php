...
// EnergyCharts SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EnergyChartsSDK::test)
...
{
    private const SDK_CLASS = 'EnergyChartsSDK';
    ...
    private const SDK_BASE = 'energycharts_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../energycharts_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
