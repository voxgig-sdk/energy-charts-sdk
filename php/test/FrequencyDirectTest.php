...
class FrequencyDirectTest extends TestCase
{
    public function test_direct_list_frequency(): void
    {
        $setup = frequency_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-frequency", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
