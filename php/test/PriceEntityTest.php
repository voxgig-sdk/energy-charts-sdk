...
class PriceEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ENERGY_CHARTS_TEST_PRICE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function price_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["price01", "price02", "price03"] as $k) {
    ...
    $entid_env_raw = getenv("ENERGY_CHARTS_TEST_PRICE_ENTID");
