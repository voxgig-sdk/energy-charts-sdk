...
// EnergyCharts SDK utility: fetcher
...
class EnergyChartsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EnergyChartsSDK/1.0)';
    ...
    public static function call(EnergyChartsContext $ctx, string $fullurl, array $fetchdef): array
    {
