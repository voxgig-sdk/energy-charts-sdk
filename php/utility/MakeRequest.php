...
// EnergyCharts SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class EnergyChartsMakeRequest
{
    public static function call(EnergyChartsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new EnergyChartsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new EnergyChartsResponse($fetched);
        } else {
