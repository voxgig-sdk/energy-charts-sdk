...
// EnergyCharts SDK utility: make_options

class EnergyChartsMakeOptions
{
    ...
    public static function call(EnergyChartsContext $ctx): array
    {
        ...
        //
        // `EnergyChartsSchema::optspec()` is built from the model:
        ...
        $optspec = EnergyChartsSchema::optspec();
