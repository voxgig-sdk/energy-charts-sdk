...
// EnergyCharts SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class EnergyChartsTransformResponse
{
    public static function call(EnergyChartsContext $ctx): mixed
    {
        ...
        $transform = EnergyChartsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
