...
The PHP SDK for the EnergyCharts API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->CrossBorderModel(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->EnergyCharts(null)->load(
    ["id" => "test01"], null
);
