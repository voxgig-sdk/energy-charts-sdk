...
// EnergyCharts SDK proxy feature
...
class EnergyChartsProxyFeature extends EnergyChartsBaseFeature
{
    ...
    public function init(EnergyChartsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EnergyChartsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
