...
// EnergyCharts SDK cache feature
...
class EnergyChartsCacheFeature extends EnergyChartsBaseFeature
{
    ...
    private function _through(EnergyChartsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
