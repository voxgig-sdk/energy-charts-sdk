...
// EnergyCharts SDK audit feature
...
class EnergyChartsAuditFeature extends EnergyChartsBaseFeature
{
    ...
    private function _emit(EnergyChartsContext $ctx, string $outcome): void
    {
