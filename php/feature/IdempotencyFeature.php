...
// EnergyCharts SDK idempotency feature
...
class EnergyChartsIdempotencyFeature extends EnergyChartsBaseFeature
{
    ...
    private function _mutating(EnergyChartsContext $ctx): bool
    {
