...
// EnergyCharts SDK timeout feature
...
class EnergyChartsTimeoutFeature extends EnergyChartsBaseFeature
{
    ...
    private function _with_timeout(EnergyChartsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EnergyChartsContext $_ctx, float $ms): void
    {
        $client = $this->client;
