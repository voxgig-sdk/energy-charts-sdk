...
// EnergyCharts SDK streaming feature
...
class EnergyChartsStreamingFeature extends EnergyChartsBaseFeature
{
    ...
    private function _iterate(EnergyChartsResult $result): \Generator
    {
    ...
    private function _streamable(EnergyChartsContext $ctx): bool
    {
