...
// EnergyCharts SDK ratelimit feature
...
class EnergyChartsRatelimitFeature extends EnergyChartsBaseFeature
{
    ...
    private function _acquire(EnergyChartsContext $ctx): void
    {
    ...
    private function _track(EnergyChartsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
