...
// EnergyCharts SDK netsim feature
...
class EnergyChartsNetsimFeature extends EnergyChartsBaseFeature
{
    ...
    private function _simulate(EnergyChartsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EnergyChartsContext $ctx, array $applied): void
    {
        $client = $this->client;
