...
const testSeed = `map[string]any{"entity": map[string]any{"cross_border_model": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "daily_avg_dict": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "frequency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "installed_model": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "price": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "production_model": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "public_power_forecast": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ren_share_model": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "share_model": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "traffic_model": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
