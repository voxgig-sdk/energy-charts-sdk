...
func NewFrequencyEntity(client *core.EnergyChartsSDK, entopts map[string]any) *FrequencyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FrequencyEntity) GetName() string { return e.name }
...
func (e *FrequencyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FrequencyEntity) Deleted() bool {
	return e.deleted
}


func (e *FrequencyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFrequencyEntity(e.client, opts)
}

func (e *FrequencyEntity) Data(args ...any) any {
...
func (e *FrequencyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Frequency; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FrequencyEntity) DataTyped(data ...Frequency) Frequency {
	if len(data) > 0 {
		return typedFrom[Frequency](e.Data(asMap(data[0])))
	}
	return typedFrom[Frequency](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Frequency (all fields
// optional at the wire level).
func (e *FrequencyEntity) MatchTyped(match ...Frequency) Frequency {
	if len(match) > 0 {
		return typedFrom[Frequency](e.Match(asMap(match[0])))
	}
	return typedFrom[Frequency](e.Match())
}
...
func (e *FrequencyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FrequencyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *FrequencyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FrequencyListMatch and returns []Frequency. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FrequencyEntity) ListTyped(reqmatch FrequencyListMatch, ctrl map[string]any) ([]Frequency, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Frequency](res), nil
}



func (e *FrequencyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FrequencyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FrequencyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FrequencyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
