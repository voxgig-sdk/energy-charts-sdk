...
func NewShareModelEntity(client *core.EnergyChartsSDK, entopts map[string]any) *ShareModelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ShareModelEntity) GetName() string { return e.name }
...
func (e *ShareModelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ShareModelEntity) Deleted() bool {
	return e.deleted
}


func (e *ShareModelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewShareModelEntity(e.client, opts)
}

func (e *ShareModelEntity) Data(args ...any) any {
...
func (e *ShareModelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ShareModel; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ShareModelEntity) DataTyped(data ...ShareModel) ShareModel {
	if len(data) > 0 {
		return typedFrom[ShareModel](e.Data(asMap(data[0])))
	}
	return typedFrom[ShareModel](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ShareModel (all fields
// optional at the wire level).
func (e *ShareModelEntity) MatchTyped(match ...ShareModel) ShareModel {
	if len(match) > 0 {
		return typedFrom[ShareModel](e.Match(asMap(match[0])))
	}
	return typedFrom[ShareModel](e.Match())
}
...
func (e *ShareModelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ShareModelEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ShareModelLoadMatch and returns an ShareModel. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ShareModelEntity) LoadTyped(reqmatch ShareModelLoadMatch, ctrl map[string]any) (ShareModel, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ShareModel{}, err
	}
	return typedFrom[ShareModel](res), nil
}



func (e *ShareModelEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ShareModelEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ShareModelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ShareModelEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ShareModelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
