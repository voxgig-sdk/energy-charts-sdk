...
type RenShareModelEntity struct {
	name    string
...
func NewRenShareModelEntity(client *core.EnergyChartsSDK, entopts map[string]any) *RenShareModelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RenShareModelEntity) GetName() string { return e.name }
...
func (e *RenShareModelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RenShareModelEntity) Deleted() bool {
	return e.deleted
}


func (e *RenShareModelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRenShareModelEntity(e.client, opts)
}

func (e *RenShareModelEntity) Data(args ...any) any {
...
func (e *RenShareModelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RenShareModel; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RenShareModelEntity) DataTyped(data ...RenShareModel) RenShareModel {
	if len(data) > 0 {
		return typedFrom[RenShareModel](e.Data(asMap(data[0])))
	}
	return typedFrom[RenShareModel](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RenShareModel (all fields
// optional at the wire level).
func (e *RenShareModelEntity) MatchTyped(match ...RenShareModel) RenShareModel {
	if len(match) > 0 {
		return typedFrom[RenShareModel](e.Match(asMap(match[0])))
	}
	return typedFrom[RenShareModel](e.Match())
}
...
func (e *RenShareModelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RenShareModelEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RenShareModelEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RenShareModelListMatch and returns []RenShareModel. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RenShareModelEntity) ListTyped(reqmatch RenShareModelListMatch, ctrl map[string]any) ([]RenShareModel, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[RenShareModel](res), nil
}



func (e *RenShareModelEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RenShareModelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RenShareModelEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RenShareModelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
