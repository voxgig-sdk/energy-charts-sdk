...
type PublicPowerForecastEntity struct {
	name    string
...
func NewPublicPowerForecastEntity(client *core.EnergyChartsSDK, entopts map[string]any) *PublicPowerForecastEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PublicPowerForecastEntity) GetName() string { return e.name }
...
func (e *PublicPowerForecastEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PublicPowerForecastEntity) Deleted() bool {
	return e.deleted
}


func (e *PublicPowerForecastEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPublicPowerForecastEntity(e.client, opts)
}

func (e *PublicPowerForecastEntity) Data(args ...any) any {
...
func (e *PublicPowerForecastEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PublicPowerForecast; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PublicPowerForecastEntity) DataTyped(data ...PublicPowerForecast) PublicPowerForecast {
	if len(data) > 0 {
		return typedFrom[PublicPowerForecast](e.Data(asMap(data[0])))
	}
	return typedFrom[PublicPowerForecast](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PublicPowerForecast (all fields
// optional at the wire level).
func (e *PublicPowerForecastEntity) MatchTyped(match ...PublicPowerForecast) PublicPowerForecast {
	if len(match) > 0 {
		return typedFrom[PublicPowerForecast](e.Match(asMap(match[0])))
	}
	return typedFrom[PublicPowerForecast](e.Match())
}
...
func (e *PublicPowerForecastEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PublicPowerForecastEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PublicPowerForecastEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PublicPowerForecastListMatch and returns []PublicPowerForecast. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PublicPowerForecastEntity) ListTyped(reqmatch PublicPowerForecastListMatch, ctrl map[string]any) ([]PublicPowerForecast, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PublicPowerForecast](res), nil
}



func (e *PublicPowerForecastEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PublicPowerForecastEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PublicPowerForecastEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PublicPowerForecastEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
