...
type InstalledModelEntity struct {
	name    string
...
func NewInstalledModelEntity(client *core.EnergyChartsSDK, entopts map[string]any) *InstalledModelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InstalledModelEntity) GetName() string { return e.name }
...
func (e *InstalledModelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InstalledModelEntity) Deleted() bool {
	return e.deleted
}


func (e *InstalledModelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInstalledModelEntity(e.client, opts)
}

func (e *InstalledModelEntity) Data(args ...any) any {
...
func (e *InstalledModelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an InstalledModel; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InstalledModelEntity) DataTyped(data ...InstalledModel) InstalledModel {
	if len(data) > 0 {
		return typedFrom[InstalledModel](e.Data(asMap(data[0])))
	}
	return typedFrom[InstalledModel](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through InstalledModel (all fields
// optional at the wire level).
func (e *InstalledModelEntity) MatchTyped(match ...InstalledModel) InstalledModel {
	if len(match) > 0 {
		return typedFrom[InstalledModel](e.Match(asMap(match[0])))
	}
	return typedFrom[InstalledModel](e.Match())
}
...
func (e *InstalledModelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InstalledModelEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *InstalledModelEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InstalledModelListMatch and returns []InstalledModel. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *InstalledModelEntity) ListTyped(reqmatch InstalledModelListMatch, ctrl map[string]any) ([]InstalledModel, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[InstalledModel](res), nil
}



func (e *InstalledModelEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InstalledModelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InstalledModelEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InstalledModelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
