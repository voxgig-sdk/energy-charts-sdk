...
type ProductionModelEntity struct {
	name    string
...
func NewProductionModelEntity(client *core.EnergyChartsSDK, entopts map[string]any) *ProductionModelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProductionModelEntity) GetName() string { return e.name }
...
func (e *ProductionModelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProductionModelEntity) Deleted() bool {
	return e.deleted
}


func (e *ProductionModelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProductionModelEntity(e.client, opts)
}

func (e *ProductionModelEntity) Data(args ...any) any {
...
func (e *ProductionModelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ProductionModel; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProductionModelEntity) DataTyped(data ...ProductionModel) ProductionModel {
	if len(data) > 0 {
		return typedFrom[ProductionModel](e.Data(asMap(data[0])))
	}
	return typedFrom[ProductionModel](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ProductionModel (all fields
// optional at the wire level).
func (e *ProductionModelEntity) MatchTyped(match ...ProductionModel) ProductionModel {
	if len(match) > 0 {
		return typedFrom[ProductionModel](e.Match(asMap(match[0])))
	}
	return typedFrom[ProductionModel](e.Match())
}
...
func (e *ProductionModelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProductionModelEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProductionModelLoadMatch and returns an ProductionModel. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ProductionModelEntity) LoadTyped(reqmatch ProductionModelLoadMatch, ctrl map[string]any) (ProductionModel, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ProductionModel{}, err
	}
	return typedFrom[ProductionModel](res), nil
}



func (e *ProductionModelEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ProductionModelEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProductionModelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ProductionModelEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProductionModelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
