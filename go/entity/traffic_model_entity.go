...
type TrafficModelEntity struct {
	name    string
...
func NewTrafficModelEntity(client *core.EnergyChartsSDK, entopts map[string]any) *TrafficModelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TrafficModelEntity) GetName() string { return e.name }
...
func (e *TrafficModelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TrafficModelEntity) Deleted() bool {
	return e.deleted
}


func (e *TrafficModelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTrafficModelEntity(e.client, opts)
}

func (e *TrafficModelEntity) Data(args ...any) any {
...
func (e *TrafficModelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TrafficModel; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TrafficModelEntity) DataTyped(data ...TrafficModel) TrafficModel {
	if len(data) > 0 {
		return typedFrom[TrafficModel](e.Data(asMap(data[0])))
	}
	return typedFrom[TrafficModel](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TrafficModel (all fields
// optional at the wire level).
func (e *TrafficModelEntity) MatchTyped(match ...TrafficModel) TrafficModel {
	if len(match) > 0 {
		return typedFrom[TrafficModel](e.Match(asMap(match[0])))
	}
	return typedFrom[TrafficModel](e.Match())
}
...
func (e *TrafficModelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TrafficModelEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TrafficModelEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TrafficModelListMatch and returns []TrafficModel. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TrafficModelEntity) ListTyped(reqmatch TrafficModelListMatch, ctrl map[string]any) ([]TrafficModel, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TrafficModel](res), nil
}



func (e *TrafficModelEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TrafficModelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TrafficModelEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TrafficModelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
