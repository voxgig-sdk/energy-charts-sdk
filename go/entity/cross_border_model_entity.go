...
type CrossBorderModelEntity struct {
	name    string
...
func NewCrossBorderModelEntity(client *core.EnergyChartsSDK, entopts map[string]any) *CrossBorderModelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CrossBorderModelEntity) GetName() string { return e.name }
...
func (e *CrossBorderModelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CrossBorderModelEntity) Deleted() bool {
	return e.deleted
}


func (e *CrossBorderModelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCrossBorderModelEntity(e.client, opts)
}

func (e *CrossBorderModelEntity) Data(args ...any) any {
...
func (e *CrossBorderModelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CrossBorderModel; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CrossBorderModelEntity) DataTyped(data ...CrossBorderModel) CrossBorderModel {
	if len(data) > 0 {
		return typedFrom[CrossBorderModel](e.Data(asMap(data[0])))
	}
	return typedFrom[CrossBorderModel](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CrossBorderModel (all fields
// optional at the wire level).
func (e *CrossBorderModelEntity) MatchTyped(match ...CrossBorderModel) CrossBorderModel {
	if len(match) > 0 {
		return typedFrom[CrossBorderModel](e.Match(asMap(match[0])))
	}
	return typedFrom[CrossBorderModel](e.Match())
}
...
func (e *CrossBorderModelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CrossBorderModelEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CrossBorderModelLoadMatch and returns an CrossBorderModel. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CrossBorderModelEntity) LoadTyped(reqmatch CrossBorderModelLoadMatch, ctrl map[string]any) (CrossBorderModel, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CrossBorderModel{}, err
	}
	return typedFrom[CrossBorderModel](res), nil
}



func (e *CrossBorderModelEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CrossBorderModelEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CrossBorderModelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CrossBorderModelEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CrossBorderModelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
