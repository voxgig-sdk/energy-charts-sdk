...
// instead of `sdk.NewEnergyChartsSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *EnergyChartsSDK  { return NewEnergyChartsSDK(nil) }
func Test() *EnergyChartsSDK { return TestSDK(nil, nil) }
