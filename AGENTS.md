...
**Entities** (10): `CrossBorderModel`, `DailyAvgDict`, `Frequency`, `InstalledModel`, `Price`, `ProductionModel`, `PublicPowerForecast`, `RenShareModel`, `ShareModel`, `TrafficModel`.
