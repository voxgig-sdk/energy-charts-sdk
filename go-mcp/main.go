// Command EnergyCharts-mcp is an MCP server exposing the EnergyCharts
// SDK as MCP tools.
//
// Two tools are registered:
//
//	EnergyCharts_list  — list records of an entity
//	EnergyCharts_load  — load a single record of an entity
//
