...
class PublicPowerForecastEntity
  ...
  def make
    opts = @_entopts.dup
    PublicPowerForecastEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [PublicPowerForecastListMatch, Hash, nil] match filter (any subset of
  #   PublicPowerForecast fields); defaults to nil, treated as an empty match that lists all.
