...
class TrafficModelEntity
  ...
  def make
    opts = @_entopts.dup
    TrafficModelEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [TrafficModelListMatch, Hash, nil] match filter (any subset of
  #   TrafficModel fields); defaults to nil, treated as an empty match that lists all.
