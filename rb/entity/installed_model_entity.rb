...
class InstalledModelEntity
  ...
  def make
    opts = @_entopts.dup
    InstalledModelEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [InstalledModelListMatch, Hash, nil] match filter (any subset of
  #   InstalledModel fields); defaults to nil, treated as an empty match that lists all.
