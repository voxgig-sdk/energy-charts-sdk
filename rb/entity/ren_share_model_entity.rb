...
class RenShareModelEntity
  ...
  def make
    opts = @_entopts.dup
    RenShareModelEntity.new(@_client, opts)
  end
  ...
  # @return [RenShareModel, Hash] the current RenShareModel data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RenShareModel fields)
  def match_get
  ...
  #
  # @param reqmatch [RenShareModelListMatch, Hash, nil] match filter (any subset of
  #   RenShareModel fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<RenShareModel>, Array] the matching RenShareModel items; raises EnergyChartsError on failure
