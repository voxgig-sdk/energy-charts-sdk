...
class ProductionModelEntity
  ...
  def make
    opts = @_entopts.dup
    ProductionModelEntity.new(@_client, opts)
  end
  ...
  # @return [ProductionModel, Hash] the current ProductionModel data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ProductionModel fields)
  def match_get
