...
class FrequencyEntity
  ...
  def make
    opts = @_entopts.dup
    FrequencyEntity.new(@_client, opts)
  end
  ...
  # @return [Frequency, Hash] the current Frequency data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Frequency fields)
  def match_get
  ...
  #
  # @param reqmatch [FrequencyListMatch, Hash, nil] match filter (any subset of
  #   Frequency fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Frequency>, Array] the matching Frequency items; raises EnergyChartsError on failure
