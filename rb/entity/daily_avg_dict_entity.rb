...
class DailyAvgDictEntity
  ...
  def make
    opts = @_entopts.dup
    DailyAvgDictEntity.new(@_client, opts)
  end
  ...
  # @return [DailyAvgDict, Hash] the current DailyAvgDict data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DailyAvgDict fields)
  def match_get
  ...
  #
  # @param reqmatch [DailyAvgDictListMatch, Hash, nil] match filter (any subset of
  #   DailyAvgDict fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<DailyAvgDict>, Array] the matching DailyAvgDict items; raises EnergyChartsError on failure
