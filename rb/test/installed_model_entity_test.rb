...
class InstalledModelEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set ENERGY_CHARTS_TEST_INSTALLED_MODEL_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def installed_model_basic_setup(extra)
  ...
  entid_env_raw = ENV["ENERGY_CHARTS_TEST_INSTALLED_MODEL_ENTID"]
