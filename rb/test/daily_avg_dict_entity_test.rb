...
class DailyAvgDictEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set ENERGYCHARTS_TEST_DAILY_AVG_DICT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def daily_avg_dict_basic_setup(extra)
  ...
  entid_env_raw = ENV["ENERGYCHARTS_TEST_DAILY_AVG_DICT_ENTID"]
