...
(0, node_test_1.describe)('FrequencyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-frequency', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-frequency', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ENERGY_CHARTS_TEST_FREQUENCY_ENTID'];
...
//# sourceMappingURL=FrequencyDirect.test.js.map