...
(0, node_test_1.describe)('TrafficModelDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-traffic_model', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-traffic_model', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'ENERGY_CHARTS_TEST_TRAFFIC_MODEL_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['ENERGY_CHARTS_TEST_TRAFFIC_MODEL_ENTID'];
...
//# sourceMappingURL=TrafficModelDirect.test.js.map