...
(0, node_test_1.describe)('InstalledModelDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-installed_model', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-installed_model', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ENERGY_CHARTS_TEST_INSTALLED_MODEL_ENTID'];
...
//# sourceMappingURL=InstalledModelDirect.test.js.map