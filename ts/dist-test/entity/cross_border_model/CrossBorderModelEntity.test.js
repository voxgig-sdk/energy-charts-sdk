...
(0, node_test_1.describe)('CrossBorderModelEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'cross_border_model.' + op, live))
                return;
        }
        ...
        let cross_border_model_ref01_data = Object.values(setup.data.existing.cross_border_model)[0];
        // LOAD
        const cross_border_model_ref01_ent = client.CrossBorderModel();
        const cross_border_model_ref01_match_dt0 = {};
        const cross_border_model_ref01_data_dt0 = (await cross_border_model_ref01_ent.load(cross_border_model_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != cross_border_model_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/cross_border_model/CrossBorderModelTestData.json');
    ...
    let idmap = transform(['cross_border_model01', 'cross_border_model02', 'cross_border_model03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['ENERGY_CHARTS_TEST_CROSS_BORDER_MODEL_ENTID'];
...
//# sourceMappingURL=CrossBorderModelEntity.test.js.map