...
(0, node_test_1.describe)('CrossBorderModelDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.EnergyChartsSDK({
    ...
    (0, node_test_1.test)('direct-load-cross_border_model', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-cross_border_model', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.ENERGY_CHARTS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'ENERGY_CHARTS_TEST_CROSS_BORDER_MODEL_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.EnergyChartsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ENERGY_CHARTS_TEST_CROSS_BORDER_MODEL_ENTID'];
    ...
    const client = new __1.EnergyChartsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CrossBorderModelDirect.test.js.map