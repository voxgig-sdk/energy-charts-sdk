...
function basicSetup(extra) {
    ...
    let idmap = transform(['price01', 'price02', 'price03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['ENERGY_CHARTS_TEST_PRICE_ENTID'];
