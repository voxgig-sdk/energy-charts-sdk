...
(0, node_test_1.describe)('PublicPowerForecastDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-public_power_forecast', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-public_power_forecast', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ENERGY_CHARTS_TEST_PUBLIC_POWER_FORECAST_ENTID'];
...
//# sourceMappingURL=PublicPowerForecastDirect.test.js.map