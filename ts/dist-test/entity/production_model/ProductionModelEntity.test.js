...
(0, node_test_1.describe)('ProductionModelEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'production_model.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set ENERGY_CHARTS_TEST_PRODUCTION_MODEL_ENTID JSON to run live');
            return;
        }
        ...
        let production_model_ref01_data = Object.values(setup.data.existing.production_model)[0];
        // LOAD
        const production_model_ref01_ent = client.ProductionModel();
        const production_model_ref01_match_dt0 = {};
        const production_model_ref01_data_dt0 = (await production_model_ref01_ent.load(production_model_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != production_model_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/production_model/ProductionModelTestData.json');
    ...
    let idmap = transform(['production_model01', 'production_model02', 'production_model03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['ENERGY_CHARTS_TEST_PRODUCTION_MODEL_ENTID'];
...
//# sourceMappingURL=ProductionModelEntity.test.js.map