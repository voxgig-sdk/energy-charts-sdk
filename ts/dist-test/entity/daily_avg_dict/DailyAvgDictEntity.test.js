...
(0, node_test_1.describe)('DailyAvgDictEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/daily_avg_dict/DailyAvgDictTestData.json');
    ...
    let idmap = transform(['daily_avg_dict01', 'daily_avg_dict02', 'daily_avg_dict03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DailyAvgDictEntity.test.js.map