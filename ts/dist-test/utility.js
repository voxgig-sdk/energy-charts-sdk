...
function envOverride(m) {
    if ('TRUE' === process.env.ENERGY_CHARTS_TEST_LIVE ||
        'TRUE' === process.env.ENERGY_CHARTS_TEST_OVERRIDE) {
    ...
    m.ENERGY_CHARTS_TEST_EXPLAIN = process.env.ENERGY_CHARTS_TEST_EXPLAIN || m.ENERGY_CHARTS_TEST_EXPLAIN;
    return m;
}
