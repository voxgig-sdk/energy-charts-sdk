...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.ENERGYCHARTS_TEST_LIVE ||
    'TRUE' === process.env.ENERGYCHARTS_TEST_OVERRIDE
  ) {
  ...
  m.ENERGYCHARTS_TEST_EXPLAIN = process.env.ENERGYCHARTS_TEST_EXPLAIN || m.ENERGYCHARTS_TEST_EXPLAIN
