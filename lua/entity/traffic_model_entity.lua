...
local TrafficModelEntity = {}
TrafficModelEntity.__index = TrafficModelEntity


function TrafficModelEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TrafficModelEntity)
  self._name = "traffic_model"
  self._client = client
...
function TrafficModelEntity:get_name()
  return self._name
end


function TrafficModelEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TrafficModelEntity.new(self._client, opts)
end
...
function TrafficModelEntity:mark_deleted()
  self._deleted = true
end


function TrafficModelEntity:deleted()
  return true == self._deleted
end


function TrafficModelEntity:data_set(args)
  if args ~= nil then
...
function TrafficModelEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TrafficModelEntity:match_set(args)
  if args ~= nil then
...
function TrafficModelEntity:match_get()
...
function TrafficModelEntity:stream(action, args, callopts)
...
function TrafficModelEntity:_run_op(ctx, post_done)
  local utility = self._utility
