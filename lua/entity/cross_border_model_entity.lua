...
local CrossBorderModelEntity = {}
CrossBorderModelEntity.__index = CrossBorderModelEntity


function CrossBorderModelEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CrossBorderModelEntity)
  self._name = "cross_border_model"
  self._client = client
...
function CrossBorderModelEntity:get_name()
  return self._name
end


function CrossBorderModelEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CrossBorderModelEntity.new(self._client, opts)
end
...
function CrossBorderModelEntity:mark_deleted()
  self._deleted = true
end


function CrossBorderModelEntity:deleted()
  return true == self._deleted
end


function CrossBorderModelEntity:data_set(args)
  if args ~= nil then
...
function CrossBorderModelEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CrossBorderModelEntity:match_set(args)
  if args ~= nil then
...
function CrossBorderModelEntity:match_get()
...
function CrossBorderModelEntity:stream(action, args, callopts)
...
function CrossBorderModelEntity:_run_op(ctx, post_done)
  local utility = self._utility
