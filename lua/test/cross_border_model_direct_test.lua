...
describe("CrossBorderModelDirect", function()
  it("should direct-load-cross_border_model", function()
    local setup = cross_border_model_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-cross_border_model", setup.live and "live" or "unit")
...
function cross_border_model_direct_setup(mockres)
