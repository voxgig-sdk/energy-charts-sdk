...
describe("PublicPowerForecastDirect", function()
  it("should direct-list-public_power_forecast", function()
    local setup = public_power_forecast_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-public_power_forecast", setup.live and "live" or "unit")
...
function public_power_forecast_direct_setup(mockres)
