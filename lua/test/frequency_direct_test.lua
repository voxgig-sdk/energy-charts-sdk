...
describe("FrequencyDirect", function()
  it("should direct-list-frequency", function()
    local setup = frequency_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-frequency", setup.live and "live" or "unit")
...
function frequency_direct_setup(mockres)
