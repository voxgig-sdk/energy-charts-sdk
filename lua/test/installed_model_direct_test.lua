...
describe("InstalledModelDirect", function()
  it("should direct-list-installed_model", function()
    local setup = installed_model_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-installed_model", setup.live and "live" or "unit")
...
function installed_model_direct_setup(mockres)
