...
describe("PriceEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ENERGY_CHARTS_TEST_PRICE_ENTID JSON to run live")
      return
    end
...
function price_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ENERGY_CHARTS_TEST_PRICE_ENTID")
