...
describe("DailyAvgDictDirect", function()
  it("should direct-list-daily_avg_dict", function()
    local setup = daily_avg_dict_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-daily_avg_dict", setup.live and "live" or "unit")
...
function daily_avg_dict_direct_setup(mockres)
