...
describe("ShareModelDirect", function()
  it("should direct-load-share_model", function()
    local setup = share_model_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-share_model", setup.live and "live" or "unit")
...
function share_model_direct_setup(mockres)
