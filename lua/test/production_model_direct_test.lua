...
describe("ProductionModelDirect", function()
  it("should direct-load-production_model", function()
    local setup = production_model_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-production_model", setup.live and "live" or "unit")
...
function production_model_direct_setup(mockres)
