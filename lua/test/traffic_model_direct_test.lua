...
describe("TrafficModelDirect", function()
  it("should direct-list-traffic_model", function()
    local setup = traffic_model_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-traffic_model", setup.live and "live" or "unit")
...
function traffic_model_direct_setup(mockres)
