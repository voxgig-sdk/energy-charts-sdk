...
describe("RenShareModelDirect", function()
  it("should direct-list-ren_share_model", function()
    local setup = ren_share_model_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-ren_share_model", setup.live and "live" or "unit")
...
function ren_share_model_direct_setup(mockres)
