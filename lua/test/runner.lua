...
function runner.env_override(m)
  local live = runner.getenv("ENERGYCHARTS_TEST_LIVE")
  local override = runner.getenv("ENERGYCHARTS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ENERGYCHARTS_TEST_EXPLAIN")
