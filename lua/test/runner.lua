...
function runner.env_override(m)
  local live = runner.getenv("ENERGY_CHARTS_TEST_LIVE")
  local override = runner.getenv("ENERGY_CHARTS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ENERGY_CHARTS_TEST_EXPLAIN")
