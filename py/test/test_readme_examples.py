# EnergyCharts SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EnergyChartsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EnergyChartsSDK(...) and EnergyChartsSDK.test(...) become
#      EnergyChartsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "energycharts_sdk"
_SDK_CLASS = "EnergyChartsSDK"
...
_ENTITIES = {
    "CrossBorderModel": "cross_border_model",
    "DailyAvgDict": "daily_avg_dict",
    "Frequency": "frequency",
    "InstalledModel": "installed_model",
    "Price": "price",
    "ProductionModel": "production_model",
    "PublicPowerForecast": "public_power_forecast",
    "RenShareModel": "ren_share_model",
