...
class TrafficModelEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TrafficModelEntity(self._client, opts)
    ...
    def data_get(self) -> TrafficModel:
    ...
    def match_get(self) -> TrafficModel:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[TrafficModel]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.TrafficModel().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
