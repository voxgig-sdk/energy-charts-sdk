...
from energycharts_sdk.energycharts_types import (
    PublicPowerForecast,
    PublicPowerForecastListMatch,
)
...
class PublicPowerForecastEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PublicPowerForecastEntity(self._client, opts)
    ...
    def data_get(self) -> PublicPowerForecast:
    ...
    def match_get(self) -> PublicPowerForecast:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PublicPowerForecast]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PublicPowerForecast().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
