...
class DailyAvgDictEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DailyAvgDictEntity(self._client, opts)
    ...
    def data_get(self) -> DailyAvgDict:
    ...
    def match_get(self) -> DailyAvgDict:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[DailyAvgDict]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.DailyAvgDict().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
