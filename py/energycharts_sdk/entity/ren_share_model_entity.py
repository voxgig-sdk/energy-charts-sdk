...
class RenShareModelEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RenShareModelEntity(self._client, opts)
    ...
    def data_get(self) -> RenShareModel:
    ...
    def match_get(self) -> RenShareModel:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[RenShareModel]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.RenShareModel().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
