...
class CrossBorderModelEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CrossBorderModelEntity(self._client, opts)
    ...
    def data_get(self) -> CrossBorderModel:
    ...
    def match_get(self) -> CrossBorderModel:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CrossBorderModel:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CrossBorderModel().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
