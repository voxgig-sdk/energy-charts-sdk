...
class InstalledModelEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return InstalledModelEntity(self._client, opts)
    ...
    def data_get(self) -> InstalledModel:
    ...
    def match_get(self) -> InstalledModel:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[InstalledModel]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.InstalledModel().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
