...
class ProductionModelEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ProductionModelEntity(self._client, opts)
    ...
    def data_get(self) -> ProductionModel:
    ...
    def match_get(self) -> ProductionModel:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ProductionModel:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ProductionModel().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
