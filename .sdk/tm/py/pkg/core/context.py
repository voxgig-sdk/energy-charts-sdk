...
from projectname_sdk.core.control import EnergyChartsControl
...
class EnergyChartsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, EnergyChartsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, EnergyChartsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, EnergyChartsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return EnergyChartsError(code, msg, self)
