...
class EnergyChartsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = EnergyChartsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = EnergyChartsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = EnergyChartsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
