...
class EnergyChartsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = EnergyChartsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = EnergyChartsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = EnergyChartsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
