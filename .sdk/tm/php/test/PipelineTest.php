...
// EnergyCharts SDK pipeline test
//
...
{
    private static function utility(): EnergyChartsUtility
    {
        return new EnergyChartsUtility();
    }
    ...
    private static function ctx(array $over = []): EnergyChartsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new EnergyChartsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new EnergyChartsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof EnergyChartsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new EnergyChartsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = EnergyChartsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new EnergyChartsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = EnergyChartsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new EnergyChartsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = EnergyChartsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new EnergyChartsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = EnergyChartsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new EnergyChartsResponse([]),
            'result' => new EnergyChartsResult([]),
        ]);
        [, $err] = EnergyChartsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new EnergyChartsSpec([]),
            'response' => null,
            'result' => new EnergyChartsResult([]),
        ]);
        [, $err] = EnergyChartsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new EnergyChartsSpec(['step' => 's']),
            'response' => new EnergyChartsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new EnergyChartsResult([]),
        ]);
        [, $err] = EnergyChartsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new EnergyChartsSpec(['step' => 's']),
            'response' => new EnergyChartsResponse(self::resp(200, ['v' => 1])),
            'result' => new EnergyChartsResult([]),
        ]);
        [, $err] = EnergyChartsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new EnergyChartsSpec(['step' => 's']),
            'response' => new EnergyChartsResponse(self::resp(200, ['v' => 2])),
            'result' => new EnergyChartsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        EnergyChartsMakeResponse::call($ctx);
    ...
    {
        $preset = new EnergyChartsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new EnergyChartsSpec([]),
            'response' => new EnergyChartsResponse([]),
            'result' => new EnergyChartsResult([]),
        ...
        [$got, $err] = EnergyChartsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new EnergyChartsResult([])]);
        [, $err] = EnergyChartsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new EnergyChartsSpec([]), 'result' => null]);
        [, $err] = EnergyChartsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new EnergyChartsSpec(['step' => 's']),
            'result' => new EnergyChartsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new EnergyChartsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = EnergyChartsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new EnergyChartsSpec(['step' => 's']),
            'result' => new EnergyChartsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new EnergyChartsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = EnergyChartsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new EnergyChartsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new EnergyChartsSpec([]),
            'result' => new EnergyChartsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = EnergyChartsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = EnergyChartsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new EnergyChartsError('boom', 'boom');
        $utility->fetcher = function (EnergyChartsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new EnergyChartsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = EnergyChartsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (EnergyChartsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = EnergyChartsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(EnergyChartsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        EnergyChartsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (EnergyChartsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new EnergyChartsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = EnergyChartsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new EnergyChartsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new EnergyChartsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = EnergyChartsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = EnergyChartsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = EnergyChartsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new EnergyChartsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, EnergyChartsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new EnergyChartsResult(['ok' => false])]);
        $this->expectException(EnergyChartsError::class);
        EnergyChartsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new EnergyChartsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', EnergyChartsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        EnergyChartsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new EnergyChartsBaseFeature();
        $b = new EnergyChartsBaseFeature();
        EnergyChartsFeatureAdd::call($ctx, $a);
        EnergyChartsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): EnergyChartsBaseFeature
    {
        $f = new EnergyChartsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        EnergyChartsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): EnergyChartsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new EnergyChartsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = EnergyChartsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        EnergyChartsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new EnergyChartsResponse(['headers' => null]),
            'result' => new EnergyChartsResult([]),
        ]);
        EnergyChartsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        EnergyChartsResultBody::call($ctx);
