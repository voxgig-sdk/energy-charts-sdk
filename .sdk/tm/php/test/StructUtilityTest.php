...
// EnergyCharts SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = EnergyChartsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(EnergyChartsOmni::structfix($now, Struct::undef()))
                        !== json_encode(EnergyChartsOmni::structfix($val, Struct::undef()))) {
