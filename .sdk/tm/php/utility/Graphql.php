...
// EnergyCharts SDK utility: graphql
//
...
class EnergyChartsGraphql
{
    ...
    // equivalent.
    public static function body(EnergyChartsContext $ctx): mixed
    {
    ...
    public static function errors(EnergyChartsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
