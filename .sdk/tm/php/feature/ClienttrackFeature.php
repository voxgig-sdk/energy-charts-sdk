...
// EnergyCharts SDK clienttrack feature
...
class EnergyChartsClienttrackFeature extends EnergyChartsBaseFeature
{
    ...
    public function PostConstruct(EnergyChartsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'EnergyCharts-SDK';
