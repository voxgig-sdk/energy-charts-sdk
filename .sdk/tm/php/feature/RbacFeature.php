...
class EnergyChartsRbacFeature extends EnergyChartsBaseFeature
{
    ...
    private function _required(EnergyChartsContext $ctx): ?string
    {
    ...
    private function _reject(EnergyChartsContext $ctx, string $required): void
    {
    ...
    private function _track(EnergyChartsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
