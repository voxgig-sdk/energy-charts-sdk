...
|---|---|---|
| `ts/` | @voxgig-sdk/energy-charts-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/energy-charts-sdk \
      --repository voxgig-sdk/energy-charts-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/energy-charts-sdk` shows it, and
`npm trust revoke @voxgig-sdk/energy-charts-sdk --id=<id>` removes it.
